...
/*
* _hole_call_sv() from Safe::Hole/0.08.
* Copied to keep compatiblity since Safe::Hole/0.09 breaks behavior of *INC for Safe::World.
*/


MODULE = Safe::World		PACKAGE = Safe::World		
